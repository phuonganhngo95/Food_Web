                            ...
                            <form id="registerForm" action="./XuLyDangKy" method="POST" novalidate>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="fullname" class="form-label">Tên tài khoản (Họ và tên) <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <div class="invalid-feedback w-100">Vui lòng nhập họ và tên của bạn.</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="invalid-feedback w-100">Vui lòng nhập tên đăng nhập.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control border-start-0" id="phone" name="phone" placeholder="Nhập số điện thoại (10 số)..." required>
                                            <div class="invalid-feedback w-100">Vui lòng nhập SĐT hợp lệ (10 số).</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="invalid-feedback w-100">Vui lòng nhập địa chỉ giao hàng.</div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control border-start-0" id="password" name="password" placeholder="Tạo mật khẩu (ít nhất 6 ký tự)..." required>
                                            <div class="invalid-feedback w-100">Vui lòng nhập mật khẩu (tối thiểu 6 ký tự).</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="invalid-feedback w-100">Mật khẩu nhập lại không khớp.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-custom w-100 py-3 fs-5 mb-3 rounded-pill fw-bold" style="background-color: var(--primary-color); color: white; border: none;">Tạo Tài Khoản</button>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.addEventListener('submit', function (event) {
                    event.preventDefault(); // Ngăn tự động gửi form

                    let isValid = true;

                    // Khai báo các trường dữ liệu dựa theo đúng ID trên HTML
                    ...
                    // Xóa toàn bộ báo lỗi cũ trước khi check
