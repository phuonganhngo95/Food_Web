            ...
            <div class="container-fluid px-4 px-lg-5">
                <div class="card shadow-sm border-0" style="border-radius: 4px;">
                    <div class="card-header bg-white text-center py-3" style="border-bottom: 1px solid #eaeaea;">
                        <h3 class="mb-0 card-title-custom text-dark">Admin</h3>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                            ...
                            <form action="SearchUserServlet" method="GET" class="d-flex" style="width: 100%; max-width: 400px;">
                                <input type="text" class="form-control form-control-custom me-2 rounded-0" name="keyword" placeholder="Enter keyword...">
                                    ...
                                    <table class="table table-hover align-middle mb-0 text-start" style="border-top: 1px solid #dee2e6;">
                                        <thead style="font-family: var(--ff-heading); font-size: 0.95rem;">
                                            <tr>
                                                ...
                                                <th scope="col" class="py-3">Profile</th>
                                                <th scope="col" class="py-3">Name</th>
                                                <th scope="col" class="py-3">Email</th>
                                                <th scope="col" class="py-3">Mobile No</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="width: 80px; height: 80px; border: 1px solid #ddd; display: flex; align-items: center; justify-content: center; overflow: hidden; background-color: #f9f9f9;">
                                                        <img src="../img/user-icon.png" alt="Profile" style="max-width: 100%; height: auto; opacity: 0.6;">
                                                    </div>
                                                </td>
                                                <td>Ngo Anh</td>
                                                <td>ngophuonganh323@gmail.com</td>
                                                <td>0388319505</td>
                                                <td>HBT,HN,TU,100000</td>
                                                <td>true</td>
                                                <td class="text-center">
                                                    <form action="UpdateUserStatusServlet" method="POST" class="d-flex justify-content-center align-items-center gap-2 mb-0">
                                                        <input type="hidden" name="userId" value="1">
                                                        <button type="submit" name="status" value="Active" class="btn btn-success btn-sm shadow-none" style="border-radius: 4px; min-width: 85px;">Active</button>
                                                        <button type="submit" name="status" value="Inactive" class="btn btn-danger btn-sm shadow-none" style="border-radius: 4px; min-width: 85px;">Inactive</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="card-footer bg-white py-3 border-top" style="border-color: #eaeaea !important;">
                        <span class="text-muted fw-medium" style="font-size: 0.95rem;">Total Admins: 1</span>
                    </div>
                </div>
            </div>
        </section>
