...
<html lang="vi">
    ...
    <body>
        ...
        <section class="admin-dashboard-section" style="margin-top: 80px; padding-bottom: 50px;">
            <div class="container">
                    ...
                    <div class="col-lg-6 col-md-8">
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-white text-center py-3" style="border-bottom: 1px solid #eaeaea;">
                                <h4 class="mb-0 fw-bold" style="font-family: var(--ff-heading); color: var(--primary-color);">Add Product</h4>
                            </div>

                            <div class="card-body p-4">
                                <form id="addProductForm" action="AddProductServlet" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="mb-3">
                                        <label for="productTitle" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Enter Title</label>
                                        <input type="text" class="form-control form-control-custom" id="productTitle" name="productTitle" required>
                                        <div class="invalid-feedback">Vui lòng nhập tên sản phẩm.</div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="productDesc" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Enter Description</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="productCategory" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Category</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="productPrice" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Enter Price</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label text-dark d-block fw-medium" style="font-size: 0.95rem;">Status</label>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <label for="productStock" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Enter Stock</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="productImage" class="form-label text-dark fw-medium" style="font-size: 0.95rem;">Upload Image</label>
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-custom py-2" style="font-size: 1.05rem; border-radius: 4px;">Submit</button>
                                    </div>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.addEventListener('submit', function (event) {
                    ...
                    if (isValid) {
                        ...
                        // form.submit(); // Mở comment dòng này ra khi đã ghép code với Backend (Servlet)
                        form.reset();
                    }
                });
            });
