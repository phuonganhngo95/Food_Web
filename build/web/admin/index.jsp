            ...
            <div class="container align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto fw-bold">
                        <li class="nav-item"><a class="nav-link active" href="../admin/index.jsp">Trang chủ</a></li>
        ...
        <section class="admin-dashboard-section" style="margin-top: 80px">
            <div class="container">
                ...
                <div class="row g-4" style="max-width: 1000px; margin: 0 auto;">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="AddCategory.jsp" class="dashboard-card theme-yellow">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="ViewProduct.jsp" class="dashboard-card theme-green">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="Orders.jsp" class="dashboard-card theme-yellow">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="Users.jsp" class="dashboard-card theme-blue">
                            <i class="fas fa-user-circle"></i>
                            <span>Users</span>
                        </a>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="AddAdmin.jsp" class="dashboard-card theme-blue">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <a href="AdminList.jsp" class="dashboard-card theme-blue">
