            ...
            <div class="container-fluid px-4 px-lg-5">
                <div class="card shadow-sm border-0" style="border-radius: 4px;">
                    <div class="card-header bg-white text-center py-3" style="border-bottom: 1px solid #eaeaea;">
                        <h3 class="mb-0 card-title-custom text-dark">All Products</h3>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                            ...
                            <form action="SearchProductServlet" method="GET" class="d-flex" style="width: 100%; max-width: 400px;">
                                <input type="text" class="form-control form-control-custom me-2 rounded-0" name="keyword" placeholder="Tìm kiếm sản phẩm...">
                                <button type="submit" class="btn btn-custom px-4 rounded-0">Search</button>
                            </form>
                        </div>
                            ...
                            <table class="table table-bordered table-hover align-middle mb-0 text-center">
                                <thead class="bg-light text-dark" style="font-family: var(--ff-heading); font-size: 0.95rem;">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 text-start">Category</th>
                                        <th scope="col" class="py-3 text-start">Price</th>
                                        <th scope="col" class="py-3 text-start">Discount</th>
                                        <th scope="col" class="py-3 text-start">Discount Price</th>
                                        <th scope="col" class="py-3 text-start">Status</th>
                                        <th scope="col" class="py-3 text-start">Stock</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=80&q=80" alt="Banh" class="rounded shadow-sm" style="width: 60px; height: 60px; object-fit: cover;">
                                        </td>
                                        <td class="text-start">Banh</td>
                                        <td class="text-start">Sweet</td>
                                        <td class="text-start">120000.0</td>
                                        <td class="text-start">0</td>
                                        <td class="text-start">120000.0</td>
                                        <td class="text-start">true</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-4.0.3&auto=format&fit=crop&w=80&q=80" alt="Pizza Hải Sản" class="rounded shadow-sm" style="width: 60px; height: 60px; object-fit: cover;">
                                        </td>
                                        <td class="text-start">Pizza Hải Sản Phô Mai</td>
                                        <td class="text-start">Pizza</td>
                                        <td class="text-start">165000.0</td>
                                        <td class="text-start">10</td>
                                        <td class="text-start">148500.0</td>
                                        <td class="text-start">true</td>
                    ...
                    <div class="card-footer bg-white d-flex flex-column flex-md-row justify-content-between align-items-center py-3 border-top" style="border-color: #eaeaea !important;">
                        <span class="text-muted fw-medium mb-3 mb-md-0" style="font-size: 0.95rem;">Total Product: 2</span>
