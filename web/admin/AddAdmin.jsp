...
<html lang="vi">
    ...
    <body>
        ...
        <section class="admin-dashboard-section" style="margin-top: 60px; padding-bottom: 50px;">
            <div class="container">
                    ...
                    <div class="col-lg-7 col-md-9">
                        ...
                        <div class="card shadow-sm border-0" style="border-radius: 4px;">
                            <div class="card-header bg-light text-center py-3" style="border-bottom: 1px solid #eaeaea;">
                                <h4 class="mb-0 fw-normal text-dark" style="font-family: var(--ff-heading);">Add Admin</h4>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <form id="addAdminForm" action="AddAdminServlet" method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            <label class="form-label text-dark small fw-bold">Address</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label text-dark small fw-bold">Confirm Password</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label text-dark small fw-bold">Profile Image</label>
                                        <input class="form-control form-control-custom rounded-0" type="file" id="profileImg" name="profileImg" accept="image/*">
                                    </div>

                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-custom py-2 rounded-0 fw-bold">Register</button>
                                    </div>
