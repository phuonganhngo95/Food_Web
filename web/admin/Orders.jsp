...
<html lang="vi">
    ...
    <head>
        ...
        <style>
            ...
            .deliver-details p, .product-details p, .price-details p {
            ...
            <div class="container-fluid px-4 px-lg-5">
                <div class="card shadow-sm border-0" style="border-radius: 4px;">
                    <div class="card-header bg-white text-center py-3" style="border-bottom: 1px solid #eaeaea;">
                        <h3 class="mb-0 card-title-custom text-dark">All Orders</h3>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                            ...
                            <form action="SearchOrderServlet" method="GET" class="d-flex" style="width: 100%; max-width: 400px;">
                                <input type="text" class="form-control form-control-custom me-2 rounded-0" name="orderId" placeholder="Enter Order Id">
                            ...
                            <table class="table table-bordered table-hover align-middle mb-0 text-start">
                                <thead class="bg-light text-dark" style="font-family: var(--ff-heading); font-size: 0.95rem;">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3">Deliver Details</th>
                                        <th scope="col" class="py-3">Date</th>
                                        <th scope="col" class="py-3">Product Details</th>
                                        <th scope="col" class="py-3">Price</th>
                                        <th scope="col" class="py-3">Status</th>
                                        <th scope="col" class="py-3 text-center" style="width: 250px;">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="fw-bold">2460ed41-6323-4065-9b37-3d1668050639</td>
                                        <td class="deliver-details">
                                            <p>Name: Ngo Anh</p>
                                            <p>Email: phanhzu95@gmail.com</p>
                                            <p>Mobile Number: 0388319505</p>
                                            <p>Address: HBT</p>
                                        </td>
                                        <td>2026-04-30</td>
                                        ...
                                        <td class="price-details">
                                            <p>Quantity: 1</p>
                                            <p>Price: 120000.0</p>
                                            <p>Total Price: 120000.0</p>
                                        </td>
                                        <td>Cancelled</td>
                                        <td>
                                            <form action="UpdateOrderStatusServlet" method="POST" class="d-flex justify-content-center align-items-center gap-2">
                                                <input type="hidden" name="orderId" value="2460ed41...">
                                                <select class="form-select form-select-sm form-select-custom rounded-0" name="status" style="width: 145px;">
                                                ...
                                                <button type="submit" class="btn btn-custom btn-sm rounded-0">Update</button>
                                            </form>
                                        </td>
                                    </tr>
                                    
                                    <tr>
                                        <td class="fw-bold">65e46ae9-b4ca-477e-8966-b9943e04c7ac</td>
                                        <td class="deliver-details">
                                            <p>Name: Ngo Anh</p>
                                            <p>Email: phanhzu95@gmail.com</p>
                                            <p>Mobile Number: 0388319505</p>
                                        ...
                                        <td>
                                            <form action="UpdateOrderStatusServlet" method="POST" class="d-flex justify-content-center align-items-center gap-2">
                                                <input type="hidden" name="orderId" value="65e46ae9...">
                                                <select class="form-select form-select-sm form-select-custom rounded-0" name="status" style="width: 145px;">
                                                    <option selected disabled>--select--</option>
                                                    <option value="In Progress">In Progress</option>
                                                    <option value="Order Received">Order Received</option>
                                    ...
                                    <tr>
                                        <td class="fw-bold">735e7744-f83f-41e0-867f-da0756d17f44</td>
                                        <td class="deliver-details">
                                            <p>Name: Ngo Anh</p>
                                            <p>Email: phanhzu95@gmail.com</p>
                                            <p>Mobile Number: 0388319505</p>
                                        ...
                                        <td>
                                            <form action="UpdateOrderStatusServlet" method="POST" class="d-flex justify-content-center align-items-center gap-2">
                                                <input type="hidden" name="orderId" value="735e7744...">
                                                <select class="form-select form-select-sm form-select-custom rounded-0" name="status" style="width: 145px;">
                                                    <option selected disabled>--select--</option>
                                                    <option value="In Progress">In Progress</option>
                                                    <option value="Order Received">Order Received</option>
                    ...
                    <div class="card-footer bg-white d-flex flex-column flex-md-row justify-content-between align-items-center py-3 border-top" style="border-color: #eaeaea !important;">
                        <span class="text-muted fw-medium mb-3 mb-md-0" style="font-size: 0.95rem;">Total Orders: 4</span>
