                    ...
                    <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0 pb-3 pb-lg-0">
                        ...
                        <div class="dropdown ms-2 position-relative">
                            ...
                            <ul class="dropdown-menu dropdown-menu-center border-0" aria-labelledby="accountDropdown">
                                <li><a class="dropdown-item py-2 active" href="DangNhap.jsp"><i class="fas fa-sign-in-alt me-2 text-muted"></i> Đăng nhập</a></li>
                                <li><a class="dropdown-item py-2" href="DangKy.jsp"><i class="fas fa-user-plus me-2 text-muted"></i> Đăng ký</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-5">
                        <div class="auth-card">
                            ...
                            <p class="auth-subtitle">Vui lòng đăng nhập để tiếp tục đặt những món ăn ngon miệng.</p>
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="text-center mt-3">
                                    ...
                                    <a href="DangKy.jsp" class="auth-link">Đăng ký ngay</a>
                                </div>
                            </form>
                        </div>
                    </div>
