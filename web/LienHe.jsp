                            ...
                            <form id="contactForm" action="./XuLyLienHe" method="POST" novalidate>
                                ...
                                <div class="mb-4 pt-2">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="file" class="form-control shopee-input" id="fileUpload" name="fileUpload" multiple accept=".jpg,.jpeg,.png,.pdf,.mp4,.xls,.xlsx,.csv,.zip,.doc,.docx">
                                        <div class="invalid-feedback" id="error-file">Vui lòng chọn tối đa 5 tệp và mỗi tệp không vượt quá 10MB.</div>
                                    </div>
                                </div>
